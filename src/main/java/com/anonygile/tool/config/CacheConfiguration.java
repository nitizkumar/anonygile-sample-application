package com.anonygile.tool.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.anonygile.tool.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.anonygile.tool.repository.UserRepository.USERS_BY_EMAIL_CACHE);
